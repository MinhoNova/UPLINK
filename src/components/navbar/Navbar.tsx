      ...
      <div className="max-w-[1600px] mx-auto px-6 w-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              className="px-3.5 py-2 rounded-xl flex items-center gap-2 font-black uppercase text-[10px] tracking-widest transition-all bg-[#5865F2]/10 text-[#aab8ff] hover:text-white border border-[#5865F2]/30 hover:bg-[#5865F2]/25 hover:border-[#5865F2]/70 shadow-[0_0_0_rgba(88,101,242,0)] hover:shadow-[0_0_16px_rgba(88,101,242,0.35)]"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="h-4 w-4 text-[#5865F2]">
