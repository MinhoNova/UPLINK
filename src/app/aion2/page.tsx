    ...
    <div className="min-h-screen bg-[#04050d] text-white relative selection:bg-cyan-500 selection:text-black font-sans overflow-x-hidden">
      ...
      <section id="club" className="relative min-h-[520px] sm:min-h-[580px] lg:min-h-[640px] flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center px-4">
          ...
          {/* Circular portal glow behind logo */}
          <div className="relative select-none">
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[320px] h-[320px] sm:w-[420px] sm:h-[420px] rounded-full bg-[radial-gradient(circle,rgba(56,189,248,0.3)_0%,rgba(139,92,246,0.2)_35%,rgba(88,28,135,0.1)_60%,transparent_75%)] blur-xl pointer-events-none" />
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[220px] h-[220px] sm:w-[280px] sm:h-[280px] rounded-full border border-cyan-400/20 pointer-events-none" />
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[180px] h-[180px] sm:w-[230px] sm:h-[230px] rounded-full border border-purple-400/15 pointer-events-none" />

            <h1 className="text-7xl sm:text-8xl md:text-9xl font-black tracking-[0.12em] font-serif leading-none relative">
              <span className="bg-gradient-to-b from-white via-cyan-100 to-sky-400 bg-clip-text text-transparent drop-shadow-[0_0_40px_rgba(56,189,248,0.8)]">AION</span>
              <span className="ml-2 sm:ml-3 bg-gradient-to-b from-cyan-200 via-sky-300 to-purple-400 bg-clip-text text-transparent drop-shadow-[0_0_50px_rgba(168,85,247,0.9)] italic">2</span>
            </h1>
          </div>
          ...
          <div className="mt-3 flex items-center justify-center gap-3">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl font-black tracking-[0.3em] uppercase bg-gradient-to-r from-cyan-200 via-white to-purple-300 bg-clip-text text-transparent font-serif">FIND YOUR CREW</h2>
            <span className="text-cyan-400 text-sm">&#10022;</span>
          </div>

          <p className="mt-2 text-[10px] sm:text-xs font-black tracking-[0.35em] text-gray-300/90 uppercase">
            KEYS <span className="text-cyan-400 mx-2">&bull;</span> BOOSTS <span className="text-purple-400 mx-2">&bull;</span> LEVELING
          </p>

          <p className="mt-2 text-xs sm:text-sm font-medium text-gray-300/70 max-w-md tracking-wide italic">
            Find trusted players for your next adventure.
          </p>

          {/* CTA Button with wing brackets */}
          <div className="mt-7 relative group">
            {/* Left bracket ornament */}
            <div className="absolute -left-8 sm:-left-10 top-1/2 -translate-y-1/2 pointer-events-none opacity-80 group-hover:opacity-100 group-hover:-translate-x-1 transition-all duration-300">
              <svg width="38" height="38" viewBox="0 0 50 50" fill="none">
                <path d="M48 25C30 25 20 18 10 5C14 16 22 23 32 25C20 27 12 34 8 45C20 32 30 25 48 25Z" fill="url(#lbGrad)" />
                <circle cx="8" cy="25" r="2" fill="#a5f3fc" />
                <defs>
                  <linearGradient id="lbGrad" x1="50" y1="25" x2="5" y2="25" gradientUnits="userSpaceOnUse">
            ...
            {/* Right bracket ornament */}
            <div className="absolute -right-8 sm:-right-10 top-1/2 -translate-y-1/2 pointer-events-none opacity-80 group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-300">
              <svg width="38" height="38" viewBox="0 0 50 50" fill="none" className="transform -scale-x-100">
                <path d="M48 25C30 25 20 18 10 5C14 16 22 23 32 25C20 27 12 34 8 45C20 32 30 25 48 25Z" fill="url(#rbGrad)" />
                <circle cx="8" cy="25" r="2" fill="#a5f3fc" />
                <defs>
                  <linearGradient id="rbGrad" x1="50" y1="25" x2="5" y2="25" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#e0f2fe" />
                    <stop offset="0.5" stopColor="#38bdf8" />
                    <stop offset="1" stopColor="#c084fc" />
                  </linearGradient>
            ...
            <button type="button" onClick={() => setShowCreate(true)} className="relative px-10 sm:px-16 py-4 rounded-full font-black uppercase tracking-[0.25em] text-xs sm:text-sm text-white bg-gradient-to-r from-[#142358] via-[#21388b] to-[#401f78] border-2 border-cyan-300/70 shadow-[0_0_30px_rgba(0,229,255,0.5),0_0_60px_rgba(139,92,246,0.3),inset_0_1px_2px_rgba(255,255,255,0.6)] hover:shadow-[0_0_45px_rgba(0,229,255,0.8),0_0_90px_rgba(139,92,246,0.5)] hover:border-white hover:scale-105 transition-all duration-300 cursor-pointer overflow-hidden">
              ...
              <span className="relative flex items-center justify-center gap-3 text-cyan-50">
                <span>CREATE YOUR OFFER</span>
                <span className="text-cyan-300 group-hover:translate-x-1 transition-transform">&rsaquo;</span>
              </span>
            </button>
          </div>
        </div>
