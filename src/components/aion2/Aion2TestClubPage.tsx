    ...
    return (
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          {bgPoster ? (
            <img src={bgPoster} alt="" className="absolute inset-0 w-full h-full object-cover opacity-60" loading="lazy" decoding="async" />
          ) : null}
                  ...
                  >
                    ...
                    {(isMine || isAdmin) && (
                      <button
                        ...
                        className="absolute -left-3 top-1/2 -translate-y-1/2 z-30 flex h-20 w-7 flex-col items-center justify-center gap-1 rounded-l-md rounded-r-md border border-cyan-400/30 bg-[#050814]/85 text-cyan-200 shadow-[0_0_12px_rgba(34,211,238,0.25)] backdrop-blur-md transition-all hover:border-[#ff007f]/60 hover:bg-[#ff007f]/15 hover:text-[#ffb3dd] hover:shadow-[0_0_16px_rgba(255,0,127,0.3)]"
                      >
