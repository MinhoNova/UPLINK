    ...
    <div className="min-h-screen bg-[#05050a] text-white">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 py-24">
        ...
        <div className="space-y-4 mb-12">
          {[
            { icon: MessageSquare, title: "Discord", desc: "Join our community Discord for fastest support, discussion, and updates.", link: "https://discord.gg/dJUPJ6xXXn", linkText: "Join Discord →" },
