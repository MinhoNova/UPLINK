      ...
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-4">
          <a
            ...
            className="group inline-flex h-11 w-11 items-center justify-center rounded-full bg-[#5865F2]/15 text-[#aab8ff] border border-[#5865F2]/40 transition-all hover:bg-[#5865F2] hover:text-white hover:scale-110"
          >
