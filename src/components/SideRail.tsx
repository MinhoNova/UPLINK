  ...
  return (
    <div className="fixed left-3 sm:left-5 top-1/2 -translate-y-1/2 z-[70] flex flex-col items-center gap-2.5">
      ...
      <a
        ...
        className={`${railBtn} text-[#aab8ff] border-[#5865F2]/40 bg-[#5865F2]/15 hover:bg-[#5865F2] hover:text-white hover:shadow-[0_0_22px_rgba(88,101,242,0.45)]`}
      >
      ...
      <a
        ...
        className={`${railBtn} ${pathname === "/support" ? "bg-yellow-500/20 border-yellow-500/50 text-yellow-300" : "text-yellow-400 border-yellow-500/30 bg-yellow-500/10 hover:bg-yellow-500 hover:text-black hover:shadow-[0_0_22px_rgba(234,179,8,0.4)]"}`}
      >
